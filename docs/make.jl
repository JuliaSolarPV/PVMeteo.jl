...
DocMeta.setdocmeta!(PVMeteo, :DocTestSetup, :(using PVMeteo); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/JuliaSolarPV/PVMeteo.jl/blob/{commit}{path}#{line}",
    sitename = "PVMeteo.jl",
    format = Documenter.HTML(; canonical = "https://JuliaSolarPV.github.io/PVMeteo.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaSolarPV/PVMeteo.jl")
